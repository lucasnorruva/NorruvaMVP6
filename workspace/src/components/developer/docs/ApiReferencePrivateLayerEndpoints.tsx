  ...
  return (
    <section id="private-layer-endpoints" className="mt-8">
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">
            Retrieve Private Supplier Attestations
          </CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              ...
              <code className="bg-muted px-1 py-0.5 rounded-sm">
                /api/v1/private/dpp/{"{productId}"}/supplier/{"{supplierId}"}
                /attestations
              </code>
            </span>
            <br />
            Fetches detailed, potentially sensitive attestations from a specific
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>
                ...
                (string, required): The unique identifier of the supplier.
              </li>
            </ul>
          </section>
          <section>
            ...
            <p className="text-sm mb-1">
              Returns an array of DetailedSupplierAttestation objects.
            </p>
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">
            Record Private B2B Component Transfer
          </CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              <Badge
            ...
            <br />
            Records the transfer of a component or sub-assembly between two
            verified entities within a private supply chain network.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>
                ...
                (string, required): The unique identifier of the product the
          ...
          <section>
            <h4 className="font-semibold mb-1">
              Request Body (JSON) - B2BComponentTransferRecord
            </h4>
            <p className="text-sm mb-1">
              Details of the component transfer. Refer to OpenAPI spec for full
              schema.
            </p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
          ...
          <section>
            ...
            <p className="text-sm mb-1">
              Returns the created B2BComponentTransferRecord with a generated
              transferId.
            </p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">
            Retrieve Private Confidential Material Details
          </CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              <Badge
            ...
            <br />
            Fetches highly detailed or proprietary material composition
            information that is not suitable for the public DPP.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <section>
          ...
          <section>
            ...
            <p className="text-sm mb-1">
              Returns a ConfidentialMaterialComposition object.
            </p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />
