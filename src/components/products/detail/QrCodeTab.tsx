  ...
  return (
    <Card className="shadow-sm">
      <CardHeader>
        ...
        <CardDescription>
          This QR code links directly to the public Digital Product Passport for
          "{productName}".
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col items-center space-y-4">
        ...
        <div className="text-center text-sm text-muted-foreground max-w-md">
          <p>
            Scan this code with any standard QR code reader on a smartphone or
            tablet to access the product's public information.
          </p>
          <p className="mt-2">
            It can be used on product packaging, labels, marketing materials, or
            at the point of sale to provide consumers and stakeholders with
            instant access to verified product data.
          </p>
        </div>
      </CardContent>
    </Card>
