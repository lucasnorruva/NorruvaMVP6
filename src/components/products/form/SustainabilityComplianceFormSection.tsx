        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="flex items-center">
              ...
              <AiIndicator
                fieldOrigin={
                  form.getValues("materialsOrigin") ||
                  initialData?.materialsOrigin
                }
            ...
            <FormControl>
              <Textarea
                ...
                onChange={(e) => {
                  field.onChange(e);
                  form.setValue("materialsOrigin", "manual");
                }}
              />
            </FormControl>
            <FormDescription>
          ...
          <FormItem>
            <div className="flex items-center justify-between">
              <FormLabel className="flex items-center">
                ...
                <AiIndicator
                  fieldOrigin={
                    form.getValues("sustainabilityClaimsOrigin") ||
                    initialData?.sustainabilityClaimsOrigin
                  }
              ...
              <Button
                ...
                disabled={isSuggestingClaimsInternal || !!isSubmittingForm}
              >
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="flex items-center">
              ...
              <AiIndicator
                fieldOrigin={
                  form.getValues("energyLabelOrigin") ||
                  initialData?.energyLabelOrigin
                }
            ...
            <FormControl>
              <Input
                ...
                onChange={(e) => {
                  field.onChange(e);
                  form.setValue("energyLabelOrigin", "manual");
                }}
              />
            </FormControl>
            <FormDescription>
