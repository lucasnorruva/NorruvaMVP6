...
export const RetailerDashboard = () => {
  ...
  const featuredProducts = MOCK_DPPS.filter(
    (p) => p.metadata.status === "published",
  ).slice(0, 3);

  const quickStats = [
    {
      title: "DPPs Viewed Recently",
      value: "78",
      icon: Eye,
      description: "(Last 7 days - Mock)",
    },
    {
      title: "Top Scanned Categories",
  ...
  const handleGeneratePosSheet = () => {
    if (!posProductId.trim()) {
      toast({
        ...
        description: "Please enter a Product ID to generate the info sheet.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (productExists) {
      toast({
        title: "Info Sheet Generation Started",
        description: `Point-of-Sale info sheet for Product ID: ${posProductId} is being generated (mock).`,
        variant: "default",
      });
      ...
      toast({
        ...
        description: `Product with ID "${posProductId}" not found.`,
        variant: "destructive",
      });
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="font-headline flex items-center">
            <FileSpreadsheet className="mr-2 text-primary" />
            Generate Point-of-Sale Info Sheet (Mock)
          </CardTitle>
          <CardDescription>
            Quickly generate a consumer-facing info sheet for a product using
            its DPP data.
          </CardDescription>
        </CardHeader>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Highlights from your product catalog.
          </CardDescription>
        </CardHeader>
                ...
                <div className="aspect-[4/3] w-full bg-muted overflow-hidden relative group">
                  <Image
                    src={
                      ...
                      "https://placehold.co/300x225.png?text=No+Image"
                    }
