...
const initialRegulations: Regulation[] = [
  {
    ...
    description:
      "Comprehensive rules for the entire life cycle of batteries, from production to reuse and recycling.",
    jurisdiction: "EU",
    applicableCategories: ["Automotive Parts", "Electronics"],
    status: "Active",
  ...
  },
  {
    ...
    description:
      "Framework to set ecodesign requirements for specific product groups to make them more durable, reliable, reusable, and recyclable.",
    jurisdiction: "EU",
  ...
  {
    id: "reg_004",
    name: "US California Proposition 65",
    description:
  ...
  },
  {
    ...
    description:
      "Harmonised rules for the marketing of construction products in the EU.",
    jurisdiction: "EU",
    applicableCategories: ["Construction Materials"],
    status: "Active",
...
export default function RegulationManagementPage() {
  ...
  const [regulations, setRegulations] =
    useState<Regulation[]>(initialRegulations);
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [editingRegulation, setEditingRegulation] = useState<Regulation | null>(
    null,
  );
  const [formData, setFormData] = useState<
    Omit<Regulation, "id" | "lastUpdated">
  >(defaultRegulationState);
  ...
  const handleDelete = (regId: string) => {
    ...
    toast({
      title: "Regulation Deleted (Mock)",
      description: `The regulation has been removed from this session.`,
      variant: "destructive",
    });
  };
    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-3xl font-headline font-semibold flex items-center">
          <ScaleIcon className="mr-3 h-7 w-7 text-primary" /> Regulation
          Management
        </h1>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Manage compliance regulations and their applicability to product
            categories.
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <TableRow key={reg.id}>
                  ...
                  <TableCell className="text-xs">
                    <div className="flex flex-wrap gap-1 max-w-sm">
                      {reg.applicableCategories.map((cat) => (
                        <Badge
                          key={cat}
                          variant="secondary"
                  ...
                  <TableCell>
                    <Badge className={cn(getStatusBadgeStyle(reg.status))}>
                      {reg.status}
                    </Badge>
                  </TableCell>
                  <TableCell className="text-right">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => handleOpenDialog(reg)}>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Define the regulation details. This is a conceptual tool to manage
              compliance logic.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4 space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="e.g., EU Battery Regulation 2023/1542"
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={handleInputChange}
                placeholder="Briefly describe the regulation's purpose."
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  name="jurisdiction"
                  onValueChange={(val) =>
                    handleSelectChange("jurisdiction", val)
                  }
            ...
            <div>
              <Label htmlFor="applicableCategories">
                Applicable Product Categories (comma-separated)
              </Label>
              <Input
