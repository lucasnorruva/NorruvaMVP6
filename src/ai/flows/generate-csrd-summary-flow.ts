...
const GenerateCsrdSummaryInputSchema = z.object({
  ...
  reportingPeriod: z
    .string()
    .describe('The reporting period, e.g., "Q2 2024", "Annual 2023".'),
  ...
  keySustainabilityInitiatives: z
    .array(z.string())
    .describe(
      "A list of key sustainability initiatives undertaken during the period.",
    ),
});
export type GenerateCsrdSummaryInput = z.infer<
  typeof GenerateCsrdSummaryInputSchema
>;

const GenerateCsrdSummaryOutputSchema = z.object({
  summaryText: z
    .string()
    .describe("A brief, professionally toned, CSRD-style executive summary."),
});
export type GenerateCsrdSummaryOutput = z.infer<
  typeof GenerateCsrdSummaryOutputSchema
>;
