    ...
    return (
      <TooltipProvider>
        <Tooltip delayDuration={100}>
          ...
          <TooltipContent>
            <p>This {fieldName.toLowerCase()} was suggested or generated by AI.</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    );
          ...
          <div className="border rounded-md overflow-hidden shadow-sm bg-muted/30 p-2">
            <AspectRatio ratio={4 / 3} className="bg-muted">
              <Image 
                ...
                priority={!currentImageUrl.startsWith("data:")} // Avoid priority for Data URIs
              />
            </AspectRatio>
            {(form.getValues("imageUrlOrigin") === 'AI_EXTRACTED' || initialImageUrlOrigin === 'AI_EXTRACTED') && (
                 <div className="text-xs text-info text-center py-1.5 flex items-center justify-center">
                    <Cpu className="h-3.5 w-3.5 mr-1"/> AI Generated Image
                 </div>
            )}
          </div>
        ) : (
