...
} from "@/utils/aiFormHelpers"; // Import helpers
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormDescription>
              Used to help generate relevant suggestions.
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
          ...
          <FormItem>
            <div className="flex items-center justify-between">
              <FormLabel className="flex items-center">
                ...
                <AiIndicator
                  fieldOrigin={
                    form.getValues("productDescriptionOrigin") ||
                    initialData?.productDescriptionOrigin
                  }
            ...
            <FormControl>
              <Textarea
                ...
                onChange={(e) => {
                  field.onChange(e);
                  form.setValue("productDescriptionOrigin", "manual");
                }}
              />
            </FormControl>
            <FormMessage />
