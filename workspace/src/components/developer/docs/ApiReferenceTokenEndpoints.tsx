    ...
    <section id="token-endpoints">
      ...
      <Card className="shadow-lg mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          <section>
            ...
            <p className="text-sm mb-1">A JSON object containing the contract address and recipient address for the token.</p>
          ...
          <section>
            ...
            <p className="text-sm mb-1">Returns a JSON object containing the token ID, contract address, and transaction hash.</p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
      ...
      <Card className="shadow-lg mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          <section>
            <h4 className="font-semibold mb-1">Request Body (JSON)</h4>
            <p className="text-sm mb-1">A JSON object containing the new metadata URI for the token.</p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />Example JSON Request Body
              </summary>
      ...
      <Card className="shadow-lg mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          <section>
            <h4 className="font-semibold mb-1">Example Response (Success 200 OK)</h4>
            <p className="text-sm mb-1">Returns a JSON object containing on-chain status information for the DPP token.</p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />Example JSON Response
              </summary>
