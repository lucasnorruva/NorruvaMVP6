...
const RecycledContentSchemaForAI = z
  .object({
    material: z
      .string()
      .optional()
      .describe("Specific material (e.g., Cobalt, Lithium)."),
    percentage: z
      .number()
      .nullable()
      .optional()
...
const ExtractProductDataOutputSchema = z.object({
  ...
  batteryChemistry: z
    .string()
    .describe(
      "The chemical composition of the battery (e.g., Li-ion NMC, LFP).",
    )
    .optional(),
  batteryPassportId: z
    .string()
    .describe("Unique identifier for the battery passport itself.")
    .optional(),
  carbonFootprint: CarbonFootprintSchemaForAI.describe(
    "Carbon footprint details of the battery.",
  ),
  recycledContent: z
    .array(RecycledContentSchemaForAI)
    .optional()
    .describe("Recycled content details for key materials in the battery."),
  stateOfHealth: StateOfHealthSchemaForAI.describe(
    "State of Health details of the battery.",
  ),
  batteryRegulationVcId: z
    .string()
    .describe(
      "Overall Verifiable Credential ID for battery regulation compliance.",
    )
    .optional(),
