...
export default function AddSupplierForm({ onSubmit, initialData, onClose, isSubmitting }: AddSupplierFormProps) {
      ...
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
        <FormField control={form.control} name="name" render={({ field }) => (
          <FormItem>
            ...
            <FormControl><Input placeholder="e.g., EcoMaterials Inc." {...field} /></FormControl>
            <FormMessage />
          </FormItem>
        )} />
        <FormField control={form.control} name="materialsSupplied" render={({ field }) => (
          <FormItem>
            <FormLabel>Materials Supplied</FormLabel>
            <FormControl><Textarea placeholder="e.g., Organic cotton, Recycled PET chips" {...field} /></FormControl>
            <FormMessage />
          </FormItem>
        )} />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField control={form.control} name="email" render={({ field }) => (
            <FormItem>
              ...
              <FormControl><Input type="email" placeholder="e.g., contact@ecomaterials.com" {...field} /></FormControl>
              <FormMessage />
            </FormItem>
          )} />
        </div>
