...
const scopeDescriptions: Record<string, string> = {
  ...
  "ebsi:verify":
    "Permission to initiate EBSI verification processes (conceptual).",
  ...
  pending_activation:
    "Key is awaiting activation and has no active scopes yet.",
  ...
  return (
    <Card className="shadow-lg" id="api_keys">
      <CardHeader>
        ...
        <CardDescription>
          Manage your API keys for accessing Norruva platform services. Scopes
                        ...
                        <TooltipProvider key={scope} delayDuration={100}>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Badge
                                variant="outline"
                                className="px-1.5 py-0.5 text-[0.65rem] bg-blue-500/10 text-blue-700 border-blue-500/30 cursor-default"
                              >
