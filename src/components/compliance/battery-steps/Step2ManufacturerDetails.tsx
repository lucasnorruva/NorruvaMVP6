...
export default function Step2ManufacturerDetails({
  step,
  formData,
  onInputChange,
  onAskCopilot,
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              onInputChange("step2", "manufacturerName", e.target.value)
            }
            placeholder="e.g., ACME Batteries Corp."
          />
        </div>
        <div>
          <Label htmlFor="step2_manufacturerAddress">
          ...
          <Textarea
            ...
            onChange={(e) =>
              onInputChange("step2", "manufacturerAddress", e.target.value)
            }
            placeholder="e.g., 123 Battery Lane, Tech City, TC 54321, Country"
          />
        </div>
        <div>
          <Label htmlFor="step2_manufacturerContact">
            Responsible Contact Person (Name / Email)
          </Label>
          <Input
            id="step2_manufacturerContact"
            value={formData.step2_manufacturerContact || ""}
            onChange={(e) =>
              onInputChange("step2", "manufacturerContact", e.target.value)
            }
