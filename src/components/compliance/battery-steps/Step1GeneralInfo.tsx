  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        <div>
          <Label htmlFor="step1_batteryModel">
            Battery Model Name / Identifier
          </Label>
          <Input
            id="step1_batteryModel"
            value={formData.step1_batteryModel || ""}
            onChange={(e) =>
              onInputChange("step1", "batteryModel", e.target.value)
            }
            placeholder="e.g., PowerCell Max 5000, LFP-Module-48V"
          />
        </div>
        <div>
          <Label htmlFor="step1_intendedApplication">
          ...
          <Textarea
            ...
            onChange={(e) =>
              onInputChange("step1", "intendedApplication", e.target.value)
            }
            placeholder="e.g., Electric vehicles, Portable electronics, Grid storage, Industrial equipment"
          />
        </div>
        <div>
          <Label htmlFor="step1_safetySheetUrl">
            Safety Data Sheet URL (Optional)
          </Label>
          <Input
            id="step1_safetySheetUrl"
            value={formData.step1_safetySheetUrl || ""}
            onChange={(e) =>
              onInputChange("step1", "safetySheetUrl", e.target.value)
            }
