...
export const SuggestKeySustainabilityPointsInputSchema = z.object({
  ...
  materials: z.string().optional().describe('Key materials used in the product (comma-separated).'),
});
export type SuggestKeySustainabilityPointsInput = z.infer<typeof SuggestKeySustainabilityPointsInputSchema>;

export const SuggestKeySustainabilityPointsOutputSchema = z.object({
  sustainabilityPoints: z.array(z.string()).describe('An array of 3-5 concise, marketable sustainability points/claims.'),
});
export type SuggestKeySustainabilityPointsOutput = z.infer<typeof SuggestKeySustainabilityPointsOutputSchema>;
