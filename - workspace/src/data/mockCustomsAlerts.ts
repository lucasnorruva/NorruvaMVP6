...
import type { CustomsAlert } from "@/types/dpp";
...
export const MOCK_CUSTOMS_ALERTS: CustomsAlert[] = [
  ...
  },
  {
    ...
    productId: "PROD999",
    message:
      "Random spot check selected for agricultural products (Batch AGR088). Expected delay: 48h.",
    severity: "Low",
  ...
  },
  {
    ...
    productId: "DPP005",
    message:
      "Carbon Footprint declaration for EV Battery (DPP005) under review. CBAM ID: CBAM_BATTERY_EV_001.",
    severity: "Medium",
