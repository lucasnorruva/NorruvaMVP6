      ...
      return [
        {
          ...
          description:
            "5 new products are awaiting compliance review in the admin dashboard.",
          time: "15m ago",
        },
        {
          id: `admin_sys_${now + 1}`,
          ...
          description:
            "All platform services are operating normally. Database backup successful.",
          time: "1h ago",
        },
      ...
      return [
        {
          ...
          description:
            "New guidance document for ESPR compliance in the 'Textiles' category published.",
          time: "30m ago",
        },
        {
          id: `mfg_sup_${now + 1}`,
          ...
          description:
            "Supplier EcoParts Ltd. has updated their material certifications for 'Recycled Polymers'.",
          time: "4h ago",
        },
        ...baseNotifications.slice(0, 2),
      ];
      ...
      return [
        {
          ...
          description:
            "Acme Corp has requested updated specifications for 'Component Alpha-7'. Deadline: EOD.",
          time: "10m ago",
        },
        {
          id: `sup_cert_${now + 1}`,
          ...
          description:
            "Your 'ISO 14001' certification for 'Eco-Solvents' is due for renewal next month.",
          time: "2d ago",
        },
        ...baseNotifications.slice(0, 2),
      ];
      ...
      return [
        {
          ...
          description:
            "DPP for 'Smart Toaster Pro X' from 'KitchenWiz' is now published and ready for consumer view.",
          time: "1h ago",
        },
        {
          id: `ret_recall_${now + 1}`,
          title: "Product Safety Alert (Mock)",
          description:
            "Minor update for 'Product Y' related to packaging information. No action required for sold units.",
          time: "1d ago",
        },
        ...baseNotifications.slice(0, 2),
      ];
      ...
      <div className="flex items-center gap-2">
        ...
        {isMobile ? (
          <Sheet>
            ...
            >
              <AppSidebarContent />{" "}
              {/* This contains its own logo when sheet is open */}
            </SheetContent>
          </Sheet>
        ) : (
