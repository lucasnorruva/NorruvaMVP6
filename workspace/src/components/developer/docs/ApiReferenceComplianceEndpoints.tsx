  ...
  return (
    <>
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">Retrieve Compliance Summary for a DPP</CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              <Badge variant="outline" className="bg-sky-100 text-sky-700 border-sky-300 mr-2 font-semibold">GET</Badge>
              <code className="bg-muted px-1 py-0.5 rounded-sm">/api/v1/dpp/&#123;productId&#125;/compliance-summary</code>
            </span>
            <br />
        ...
        <CardContent className="space-y-4">
          ...
          <section>
            ...
            <p className="text-sm mb-1">Returns a JSON object containing a summary of the product's compliance status, including an overall status and statuses for various compliance regimes.</p>
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">Verify a Digital Product Passport</CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              <Badge variant="outline" className="bg-green-100 text-green-700 border-green-300 mr-2 font-semibold">POST</Badge>
              <code className="bg-muted px-1 py-0.5 rounded-sm">/api/v1/dpp/verify/&#123;productId&#125;</code>
            </span>
            <br />
        ...
        <CardContent className="space-y-4">
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>
                <code className="bg-muted px-1 py-0.5 rounded-sm font-mono text-xs">&#123;productId&#125;</code> (path, required): The unique identifier of the product to verify.
              </li>
            </ul>
          </section>
          <section>
            <h4 className="font-semibold mb-1">Example Response (Success 200 OK)</h4>
            <p className="text-sm mb-1">Returns a JSON object indicating the verification status, a message, and the timestamp of the verification.</p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />Example JSON Response
              </summary>
