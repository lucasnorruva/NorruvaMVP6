    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-foreground">
          You have reached the final step. Please review all the information
          entered in the previous steps for accuracy and completeness. Ensure
          all data aligns with the EU Battery Regulation requirements.
        </p>
        <div className="p-4 border rounded-md bg-muted/50">
          ...
          <ul className="list-disc list-inside text-sm space-y-1 text-muted-foreground">
            ...
            <li>
              Ensure any linked documents or URLs are correct and accessible.
            </li>
            <li>
              Confirm consistency of information across different sections.
            </li>
          </ul>
        </div>
        <p className="text-xs text-muted-foreground">
          Once you are satisfied, you can proceed to mock submit this pathway.
          In a real scenario, this would trigger formal data submission
          processes.
        </p>
        <Button
          variant="outline"
