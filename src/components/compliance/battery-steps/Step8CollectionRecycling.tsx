...
export default function Step8CollectionRecycling({
  step,
  formData,
  onInputChange,
  onRadioChange,
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        <div>
          <Label htmlFor="step8_producerResponsibilityStatement">
            Producer Responsibility Statement
          </Label>
          <Textarea
            ...
            onChange={(e) =>
              onInputChange(
                "step8",
                "producerResponsibilityStatement",
                e.target.value,
              )
            }
        ...
        <div>
          <Label htmlFor="step8_collectionRecyclingInfoUrl">
            URL to Collection & Recycling Information
          </Label>
          <Input
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Link to publicly available information on collection, take-back, and
            recycling schemes.
          </p>
        </div>
        <div>
          <Label htmlFor="step8_takeBackSchemesDescription">
            Description of Take-back & Collection Schemes
          </Label>
          <Textarea
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <RadioGroup
              value={
                formData.step8_recyclingEfficiencyTargetMet ||
                "not_yet_assessed"
              }
              onValueChange={(value) =>
                onRadioChange("step8", "recyclingEfficiencyTargetMet", value)
              }
          ...
          <div>
            ...
            <RadioGroup
              value={
                formData.step8_materialRecoveryTargetsMet || "not_yet_assessed"
              }
              onValueChange={(value) =>
                onRadioChange("step8", "materialRecoveryTargetsMet", value)
              }
              className="space-y-1.5"
            >
              <div className="flex items-center space-x-2">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              For Cobalt, Copper, Lead, Lithium, Nickel (Annex XII, Part B).
            </p>
          </div>
        </div>
        <Button
