...
export const ALL_NAV_ITEMS: NavItemConfig[] = [
  ...
  { href: "/my-products", label: "My Tracked Products", icon: Bookmark, group: 'main', requiredRoles: ['admin', 'manufacturer', 'supplier', 'retailer', 'recycler', 'verifier', 'service_provider'] }, 
