...
const mockAuditLogs: AuditLogEntry[] = [
  ...
  },
  {
    ...
    actor: "System",
    actionType: "DPP Generation",
    details: "DPP for PROD005 (Solar Powered Garden Light) generated.",
    status: "Success",
  },
  {
    id: "log003",
    timestamp: new Date(Date.now() - 1000 * 60 * 30).toISOString(),
    actor: "manufacturer@acme.com",
    actionType: "Product Update",
    details: "Product PROD001 (EcoFriendly Refrigerator) description updated.",
  ...
  },
  {
    ...
    details: "Automated EPREL sync for PROD001: Data Matched.",
    status: "Info",
  },
  {
    id: "log005",
    timestamp: new Date(Date.now() - 1000 * 60 * 60).toISOString(),
    actor: "supplier@greenparts.co",
    actionType: "Document Upload",
    details: "Uploaded new material spec sheet 'GPS-Material-X.pdf'.",
  ...
  },
  {
    ...
    actor: "verifier@certify.org",
    actionType: "DPP Verification",
    details: "EBSI verification for PROD002 (Smart LED Bulb) initiated.",
  ...
  },
  {
    ...
    actor: "retailer@shopmart.com",
    actionType: "API Access",
    details: "Accessed DPP data for PROD001 via API.",
  ...
  },
  {
    ...
    details:
      "User 'bob@example.com' role changed from Supplier to Manufacturer.",
    ipAddress: "192.168.1.10",
    status: "Success",
  },
  {
  ...
  },
  {
    ...
    details: "New product 'Smart Toaster v2' created in draft.",
    ipAddress: "203.0.113.45",
    status: "Success",
  },
  {
    ...
    details:
      "Webhook to 'https://partner.com/hook' failed for event 'dpp.updated'.",
    status: "Failure",
  },
  {
    id: "log013",
    ...
    details: "New production API key generated for 'RetailPartnerX'.",
    ipAddress: "192.168.1.10",
    status: "Success",
  },
  {
    ...
    actor: "supplier@greenparts.co",
    actionType: "Data Request Response",
    details: "Responded to data request for 'Component Y' from 'Acme Corp'.",
    ipAddress: "198.51.100.22",
    status: "Success",
  },
  {
    ...
    details:
      "User 'admin@norruva.com' exported compliance data for 'Appliances' category.",
    status: "Info",
  },
  {
    id: "log016",
    ...
    actor: "verifier@certify.org",
    actionType: "Audit Trail Accessed",
    details: "Accessed audit trail for product PROD001.",
    ipAddress: "203.0.113.110",
    status: "Info",
  },
  {
    ...
    details: "Generated 'Top Viewed DPPs' report for last month.",
    ipAddress: "192.0.2.88",
    status: "Success",
  },
  {
    ...
    details: "Daily platform data backup completed successfully.",
    status: "Success",
  },
  {
    id: "log019",
    ...
    details: "Updated GDPR consent options in platform settings.",
    ipAddress: "192.168.1.10",
    status: "Success",
  },
  {
    ...
    details: "Product 'Old Model Toaster' (PROD-OLD-001) archived.",
    ipAddress: "203.0.113.45",
    status: "Success",
  },
  {
    id: "log021",
    timestamp: new Date(Date.now() - 1000 * 60 * 570).toISOString(),
    actor: "System",
    actionType: "Compliance Alert",
    details: "Product PROD004 flagged for non-compliance review (REACH).",
    status: "Failure",
  },
  {
    id: "log022",
  ...
  },
  {
    ...
    actor: "System",
    actionType: "User Invitation Sent",
    details: "Invitation sent to 'new.user@example.com' for 'Retailer' role.",
    status: "Info",
  },
  {
    id: "log024",
    ...
    actor: "verifier@certify.org",
    actionType: "DPP Verification Rejected",
    details:
      "EBSI verification for PROD-TEST-007 rejected due to data mismatch.",
    ipAddress: "203.0.113.110",
    status: "Failure",
  },
  {
    ...
    actor: "admin@norruva.com",
    actionType: "User Login",
    details: "Admin user logged in successfully from a new device.",
  ...
  },
  {
    ...
    actor: "System",
    actionType: "AI Model Update",
    details: "AI model for product data extraction updated to v1.2.",
    status: "Info",
  },
  {
    id: "log027",
    ...
    actionType: "Product Update",
    details:
      "Updated sustainability claims for 'EcoFriendly Refrigerator X2000'.",
    ipAddress: "203.0.113.45",
    status: "Success",
  },
];
  ...
  const getStatusBadge = (
    ...
    return (
      <Badge variant={variant} className={cn("capitalize text-xs", className)}>
        <IconCmpt className="mr-1 h-3 w-3" />
        {status}
      </Badge>
    );
  };
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-md">
        <CardHeader>
          ...
          <CardDescription>
            Refine the list of audit logs using the filters below. Use the
            calendar to select date ranges.
          </CardDescription>
        </CardHeader>
        <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
          <div>
            ...
            <DatePicker
              ...
              setDate={(date) => handleDateFilterChange("dateFrom", date)}
          ...
          <div>
            ...
            <DatePicker
              date={filters.dateTo}
              setDate={(date) => handleDateFilterChange("dateTo", date)}
          ...
          <div>
            ...
            <Input
              ...
              value={filters.actor}
              onChange={(e) =>
                handleStringFilterChange("actor", e.target.value)
              }
            />
          </div>
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                handleStringFilterChange("actionType", value)
              }
            >
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Page {currentPage} of {totalPages}. Displaying{" "}
            {paginatedLogs.length} records (filtered from {mockAuditLogs.length}{" "}
            total).
          </CardDescription>
        </CardHeader>
        <CardContent>
