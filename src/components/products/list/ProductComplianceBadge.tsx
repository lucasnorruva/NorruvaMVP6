...
export default function ProductComplianceBadge({
  compliance,
  ...
  const getComplianceBadgeVariant = (c: DisplayableProduct["compliance"]) => {
    switch (c) {
      ...
      case "N/A":
        return "secondary";
      default:
        return "destructive"; // Non-Compliant or other issues
    }
  };
  ...
  const getComplianceBadgeClass = (c: DisplayableProduct["compliance"]) => {
    switch (c) {
      ...
      default:
        return "bg-red-100 text-red-700 border-red-300"; // Non-Compliant
    }
  };
