...
import { Server } from "lucide-react"; // Changed import from 'lucide-react' to 'lucide-react'
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <>
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            The Norruva DPP API provides programmatic access to Digital Product
            Passport data. All API access is over HTTPS and uses standard HTTP
            features.
          </CardDescription>
        </CardHeader>
