...
import { Scale, Info, Settings } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <Card className="shadow-lg">
        <CardHeader>
            ...
            <CardDescription>Conceptual alignment with major EU product regulations.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
            <section>
                ...
                <Button variant="link" className="p-0 h-auto text-xs mt-1" disabled>View ESPR Guidance (Coming Soon)</Button>
            </section>
            <section>
             ...
             <section>
                ...
                <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1 mt-2">
                    ...
                    <li><strong>SCIP Database (Substances of Concern In articles as such or complex objects (Products)):</strong> DPPs can help manage and track SVHC information required for SCIP notifications.</li>
