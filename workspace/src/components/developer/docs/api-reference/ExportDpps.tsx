    ...
    <Card className="shadow-lg mt-6">
      <CardHeader>
        <CardTitle className="text-lg">
          Export Digital Product Passports
        </CardTitle>
        <CardDescription>
          ...
          <br />
          Allows for exporting DPP data in various formats. This is a conceptual
          endpoint.
        </CardDescription>
      </CardHeader>
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-sm space-y-1">
            <li>
              ...
              (string, optional): Comma-separated list of product IDs to export
              (e.g., "DPP001,DPP002").
            </li>
            <li>
              <code className="bg-muted px-1 py-0.5 rounded-sm font-mono text-xs">
              ...
              (string, optional, enum: "json", "csv", "xml", default: "json"):
            ...
            <li>
              ...
              (string, optional): Comma-separated list of specific fields to
              include (e.g., "id,productName,category").
            </li>
          </ul>
        </section>
        <section>
          ...
          <p className="text-sm mb-1">
            Content-Type will vary based on the 'format' parameter. For{" "}
            <code className="bg-muted px-1 py-0.5 rounded-sm font-mono text-xs">
              format=json
            </code>
            :
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-sm space-y-2">
            ...
            <li>
              ...
              : No products found matching criteria or specified IDs.
              <details className="border rounded-md mt-1">
                <summary className="cursor-pointer p-1 bg-muted hover:bg-muted/80 text-xs ml-4">
                  Example JSON
                </summary>
