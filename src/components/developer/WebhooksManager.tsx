    ...
    <Card className="shadow-lg" id="webhooks-manager">
      <CardHeader>
        <CardTitle className="font-headline flex items-center">
          <Webhook className="mr-3 h-6 w-6 text-primary" /> Webhooks
        </CardTitle>
        <CardDescription>
      ...
      <CardContent className="space-y-4">
        <Table>
          ...
          <TableBody>
            {webhooks.map((wh) => (
              <TableRow key={wh.id}>
                <TableCell className="truncate max-w-[150px] sm:max-w-[200px] text-sm font-mono">
                  {wh.url}
                </TableCell>
        ...
        <p className="text-xs text-muted-foreground">
          Get notified about product updates, compliance changes, and more by
