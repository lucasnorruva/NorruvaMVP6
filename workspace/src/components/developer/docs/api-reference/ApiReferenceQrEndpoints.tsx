...
export default function ApiReferenceQrEndpoints({
  ...
  const qrEndpoints: EndpointDefinition[] = [
    ...
    { 
      ...
      pathParams: [{name: "productId", type: "string", required: true, description: "Unique product ID."}], 
      responseExample: JSON.stringify({ qrCode: "data:image/png;base64,...", productId: "DPP001", linksTo: "/passport/DPP001" }, null, 2), 
    ...
    { 
      ...
      description: "Returns a QR code image directly, linking to the public passport.", 
      pathParams: [{name: "productId", type: "string", required: true, description: "Unique product ID."}], 
