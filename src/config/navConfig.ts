...
import {
  ...
  ListChecks, Bot, ShieldCheck, Fingerprint, ClipboardList, Globe2, Code2, Settings, LineChart
} from 'lucide-react';
...
export const ALL_NAV_ITEMS: NavItemConfig[] = [
  // Main Group
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, group: 'main', requiredRoles: ['admin', 'manufacturer', 'supplier', 'retailer', 'recycler', 'verifier'] },
  { href: "/dpp-live-dashboard", label: "Live DPPs", icon: LineChart, group: 'main', requiredRoles: ['admin', 'manufacturer', 'supplier', 'retailer', 'recycler', 'verifier'] },
  ...
  // Compliance Group
  { href: "/compliance/pathways", label: "Compliance Pathways", icon: ListChecks, group: 'compliance', requiredRoles: ['admin', 'manufacturer', 'supplier', 'verifier'] },
  { href: "/copilot", label: "AI Co-Pilot", icon: Bot, group: 'compliance', requiredRoles: ['admin', 'manufacturer', 'supplier', 'retailer', 'recycler', 'verifier'] },
  ...
  { href: "/settings", label: "Settings", icon: Settings, group: 'secondary', requiredRoles: ['admin', 'manufacturer', 'supplier', 'retailer', 'recycler', 'verifier'] },
];
