...
export default function ApiReferencePrivateLayerEndpoints({
  ...
  const privateEndpoints: EndpointDefinition[] = [
    {
      id: "getSupplierAttestations",
      title: "Retrieve Private Supplier Attestations",
      method: "GET",
      path: "/api/v1/private/dpp/{productId}/supplier/{supplierId}/attestations",
      description:
      ...
      responseSchema: "DetailedSupplierAttestation[]",
      responseExample: exampleGetSupplierAttestationsResponseBody,
      commonErrors: ["401", "404", "500"],
    },
    {
      id: "recordComponentTransfer",
      title: "Record Private B2B Component Transfer",
      method: "POST",
      path: "/api/v1/private/dpp/{productId}/component-transfer",
      description:
        "Records the transfer of a component between verified entities.",
      pathParams: [
        {
          name: "productId",
          type: "string",
      ...
      requestBodySchema: "B2BComponentTransferRecord",
      requestBodyExample: exampleB2BComponentTransferRequestBody,
      responseSchema: "B2BComponentTransferRecord",
      responseExample: exampleB2BComponentTransferResponseBody,
      commonErrors: ["400", "401", "404", "500"],
    },
    {
      id: "getConfidentialMaterials",
      title: "Retrieve Private Confidential Material Details",
      method: "GET",
      path: "/api/v1/private/dpp/{productId}/confidential-materials",
      description:
        "Fetches highly detailed or proprietary material composition information.",
      pathParams: [
        {
          name: "productId",
          type: "string",
      ...
      responseSchema: "ConfidentialMaterialComposition",
      responseExample: exampleGetConfidentialMaterialsResponseBody,
      commonErrors: ["401", "404", "500"],
    },
  ];
  ...
  return (
    <section id="private-layer-endpoints" className="mt-8">
      <h2 className="text-2xl font-semibold font-headline mt-8 mb-4 flex items-center">
        <Layers3 className="mr-3 h-6 w-6 text-primary" /> Private Layer
        Endpoints (Conceptual)
      </h2>
      <p className="text-sm text-muted-foreground mb-4">
        Endpoints for managing sensitive, permissioned B2B data not suitable for
        the public DPP. Access to these endpoints would conceptually require
        enhanced authentication beyond standard API keys.
      </p>
