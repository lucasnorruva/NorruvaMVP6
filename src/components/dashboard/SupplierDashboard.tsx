...
import { Layers, Inbox, FileText, AlertTriangle, MessageSquare } from "lucide-react";
...
export const SupplierDashboard = () => {
  const keyMetrics = [
    { title: "Active Data Requests", value: "5", icon: Inbox, color: "text-info", description: "From Manufacturers" },
    { title: "Submitted Compliance Declarations", value: "87", icon: FileText, color: "text-green-600", description: "Total Submitted" },
    { title: "Materials Awaiting Update", value: "3", icon: AlertTriangle, color: "text-orange-500", description: "Spec Update Needed" },
  ];
