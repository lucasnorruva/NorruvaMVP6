  ...
  return (
    <section id="zkp-layer-endpoints">
      <h2 className="text-2xl font-semibold font-headline mt-8 mb-4 flex items-center">
        <Server className="mr-3 h-6 w-6 text-primary" /> Zero-Knowledge Proof Endpoints (Conceptual)
      </h2>
      ...
      <Card className="shadow-lg mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-2">
              <li>
                <code className="bg-muted px-1 py-0.5 rounded-sm font-mono text-xs">400 Bad Request</code> (e.g., missing claimType).
                <details className="border rounded-md mt-1">
                  <summary className="cursor-pointer p-1 bg-muted hover:bg-muted/80 text-xs ml-4">Example JSON</summary>
                  <pre className="bg-muted/50 p-2 rounded-b-md text-xs overflow-x-auto ml-4"><code>{error400General}</code></pre>
                </details>
