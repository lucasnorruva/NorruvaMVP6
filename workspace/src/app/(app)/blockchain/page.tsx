 ...
 useEffect(() => {
  ...
  const handleAnchor = async (e: FormEvent) => {
    ...
    if (res.ok) {
      ...
      toast({ 
        title: "DPP Anchored", 
        description: `Product ${selected.productName} successfully anchored to ${anchorPlatform}. Conceptual token ID ${data.blockchainIdentifiers?.tokenId} and contract address ${data.blockchainIdentifiers?.contractAddress} assigned.` 
      });
    } else {
