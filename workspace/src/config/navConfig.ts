...
export interface NavItemConfig {
  ...
  group:
    ...
    | "specialized"
    | "secondary"
    | "analytics"; // Added analytics group
...
export const ALL_NAV_ITEMS: NavItemConfig[] = [
  ...
  // Analytics Group
  {
    href: "/data-insights-dashboard",
    label: "Data Insights",
    icon: BarChartBig,
    group: "analytics",
    requiredRoles: ["admin", "business_analyst"],
  },
  ...
  // Sustainability Group
  {
    ...
    requiredRoles: ["admin", "manufacturer", "verifier", "business_analyst"],
  },
  {
    href: "/sustainability/compare",
    label: "Compare Sustainability",
  ...
  {
    href: "/dpp-global-tracker-v2",
    label: "DPP Global Tracker v2",
    icon: Globe2,
    group: "specialized",
    requiredRoles: [
      "admin",
