  ...
  return (
    <section id="zkp-layer-endpoints">
      <h2 className="text-2xl font-semibold font-headline mt-8 mb-4 flex items-center">
        <Server className="mr-3 h-6 w-6 text-primary" /> Zero-Knowledge Proof
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">
            Submit Zero-Knowledge Proof for a DPP
          </CardTitle>
          <CardDescription>
            ...
            <br />
            [ZKP Layer - Highly Conceptual] Allows a prover (e.g., manufacturer,
            supplier) to submit a Zero-Knowledge Proof (ZKP) related to a
            specific DPP. This endpoint is a placeholder for a complex ZKP
            system interaction.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li>
                ...
                (path, required): The unique identifier of the Digital Product
                Passport this proof relates to.
              </li>
            </ul>
          </section>
          <section>
            ...
            <p className="text-sm mb-1">
              A JSON object containing the claim type, proof data, and any
              public inputs.
            </p>
          ...
          <section>
            <h4 className="font-semibold mb-1">
              Example Response (Success 202 Accepted)
            </h4>
            <p className="text-sm mb-1">
              Returns a JSON object acknowledging the ZKP submission.
            </p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-2">
              <li>
                ...
                : Invalid request body (e.g., missing claimType or proofData).
              ...
              <li>
                ...
                : DPP with the given dppId not found.
                <details className="border rounded-md mt-1">
                  <summary className="cursor-pointer p-1 bg-muted hover:bg-muted/80 text-xs ml-4">
                    Example JSON
                  </summary>
      ...
      <Card className="shadow-lg mt-6">
        <CardHeader>
          <CardTitle className="text-lg">
            Verify Claim with ZKP for a DPP
          </CardTitle>
          <CardDescription>
            <span className="inline-flex items-center font-mono text-sm">
              <Badge
              ...
              <code className="bg-muted px-1 py-0.5 rounded-sm">
                /api/v1/zkp/verify-claim/&#123;dppId&#125;?claimType=&#123;claimType&#125;
              </code>
            </span>
            <br />
            [ZKP Layer - Highly Conceptual] Allows a verifier to check if a
            specific claim for a DPP has a valid (mock) Zero-Knowledge Proof
            associated with it.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              ...
              <li>
                ...
                (query, required): The type of claim to verify (e.g.,
                "material_compliance_svhc_x", "ethical_sourcing_region_y").
              </li>
            </ul>
          </section>
          <section>
            ...
            <p className="text-sm mb-1">
              Returns the verification status of the ZKP claim.
            </p>
            <details className="border rounded-md">
              <summary className="cursor-pointer p-2 bg-muted hover:bg-muted/80 text-sm">
                <FileJson className="inline h-4 w-4 mr-1 align-middle" />
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-sm space-y-2">
              ...
              <li>
                ...
                (DPP or specified claim proof not found).
                <details className="border rounded-md mt-1">
                  <summary className="cursor-pointer p-1 bg-muted hover:bg-muted/80 text-xs ml-4">
                    Example JSON
                  </summary>
