  ...
  <div className="space-y-6">
    <Card className="shadow-lg">
      <CardHeader>
        ...
        <CardDescription>
          Verify product claims and audit Digital Product Passports.
        </CardDescription>
      </CardHeader>
    ...
    <Card>
      ...
      <CardContent>
        <p className="text-muted-foreground">
          New regulation update requires re-verification for 'Textile' category.
          Multiple DPPs flagged for potential data mismatch.
        </p>
      </CardContent>
    </Card>
