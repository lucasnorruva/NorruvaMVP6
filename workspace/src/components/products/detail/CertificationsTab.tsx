      ...
      <Card className="shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg font-semibold flex items-center">
            <Award className="mr-2 h-5 w-5 text-primary" /> Product
            Certifications
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          >
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2">
              ...
              {cert.isVerified && (
                <Badge
                  variant="default"
                  className="mt-1 sm:mt-0 text-xs bg-green-100 text-green-700 border-green-300"
                >
                  Verified
                </Badge>
              )}
            ...
            <div className="text-xs space-y-1.5 text-muted-foreground">
              ...
              {cert.standard && (
                <p>
                  <strong className="text-foreground/80">Standard:</strong>{" "}
                  {cert.standard}
                </p>
              )}
              <p className="flex items-center">
                ...
                {cert.expiryDate && (
                  <span className="ml-2">
                    <strong className="text-foreground/80">Expires:</strong>{" "}
                ...
                <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    ...
                    <TooltipContent
                      side="bottom"
                      align="start"
                      className="bg-popover text-popover-foreground shadow-lg rounded-md p-2 border max-w-xs"
                    >
