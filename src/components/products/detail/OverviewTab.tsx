...
import {
  ...
  KeyRound,
  ExternalLink,
} from "lucide-react"; // Added KeyRound, ExternalLink
        ...
        {(product.gtin ||
          ...
          <Card className="shadow-sm">
            ...
            <CardContent className="text-sm space-y-1.5">
              ...
              {product.gtin && (
                <p>
                  <strong className="text-muted-foreground">GTIN:</strong>{" "}
                  {product.gtin}
                </p>
              )}
              {product.modelNumber && (
                <p>
                  <strong className="text-muted-foreground">Model:</strong>{" "}
                  {product.modelNumber}
                </p>
              )}
              {product.nfcTagId && (
                <p>
                  <strong className="text-muted-foreground">NFC Tag ID:</strong>{" "}
                  {product.nfcTagId}
                </p>
              )}
              {product.rfidTagId && (
            ...
            <CardContent className="text-sm space-y-2">
              {product.authenticationVcId && (
                <div>
                  <strong className="text-muted-foreground flex items-center">
                    <Fingerprint className="mr-1.5 h-4 w-4 text-indigo-500" />
                    Authenticity VC ID:
                  </strong>
              ...
              {product.ownershipNftLink && (
                <div className="mt-1.5 pt-1.5 border-t border-border/50">
                  <strong className="text-muted-foreground block mb-0.5">
                    Ownership NFT:
                  </strong>
                  <p>
                    Token ID:{" "}
