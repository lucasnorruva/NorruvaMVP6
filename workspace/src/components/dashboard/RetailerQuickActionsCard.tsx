...
export const RetailerQuickActionsCard = () => {
  const actions = [
    {
      label: "Access Public DPPs",
      href: "/dpp-live-dashboard",
      icon: ScanLine,
      description: "View DPPs for products you sell.",
    },
    {
      label: "Download Product Data",
      href: "#",
      icon: DownloadCloud,
      description: "Get data sheets for marketing (mock).",
    },
    {
      label: "View Consumer Insights",
      href: "#",
      icon: Users,
      description: "See consumer interaction data (mock).",
    },
    {
      label: "Manage Point-of-Sale Info",
      href: "#",
      icon: ShoppingBag,
      description: "Update POS display information (mock).",
    },
  ];
  return (
