...
import Link from "next/link"; // Ensure this import is present and correct
import {
  Card,
  CardContent,
  CardHeader,
...
const TOKEN_EXPLORER_BASE_URL =
  "https://mock-token-explorer.example.com/token/"; // General token explorer
                            ...
                            <Card className="bg-background mt-6 md:col-span-2">
                              ...
                              <CardContent className="grid sm:grid-cols-2 gap-x-6 gap-y-8">
                                ...
                                >
                                  ...
                                  <Textarea
                                    value={criticalEventLog}
                                    onChange={(e) =>
                                      setCriticalEventLog(e.target.value)
                                    }
