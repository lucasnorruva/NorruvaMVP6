    ...
    >
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            The EU's Carbon Border Adjustment Mechanism (CBAM) aims to price
            carbon on certain imported goods to prevent carbon leakage and
            encourage global decarbonization.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <p>
            Initially, CBAM covers imports in sectors like cement, iron/steel,
            aluminium, fertilisers, electricity, and hydrogen. This list may
            expand.
          </p>
          <p className="text-sm text-muted-foreground">
            The full conceptual details, including specific data points and
            workflows, are outlined in the{" "}
            <code className="bg-muted px-1 py-0.5 rounded-sm">
              docs/cbam-pathway-concepts.md
            </code>{" "}
            file within this project's repository.
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center">
            ...
            Key DPP Data for CBAM
          </CardTitle>
          <CardDescription>
            DPPs can be vital for managing CBAM-related data. Key elements
            include:
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center">
            ...
            How Norruva Platform Supports CBAM (Conceptual)
          </CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <p className="mt-3 text-sm">
            By structuring data relevant to CBAM within the DPP, the Norruva
            platform aims to simplify compliance for businesses involved in
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            For detailed information on CBAM, refer to official EU Commission
            resources. The integration points and data fields mentioned here are
            conceptual and aim to align with anticipated CBAM reporting needs.
            The actual fields required for CBAM declarations will be defined by
            specific EU implementing acts.
          </p>
        </CardContent>
      </Card>
    </DocsPageLayout>
